...
//        panos_App_1.Block myblock = new panos_App_1.Block(b1.getBlocks().get(b1.getBlocks().size()-1).getHash(),"Data for second",new Date().getTime());
//        b1.addBlock(myblock);



//        test for fake blocks
//        panos_App_1.Block fakeblock = new panos_App_1.Block("dsfssdfsd","Data for second",new Date().getTime());
